...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-mono text-muted-foreground tracking-widest">AI SEC OPS</span>
            </div>
          )}
        </div>
      </SidebarHeader>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-[10px] tracking-widest text-muted-foreground/60 uppercase">
            Operations
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
